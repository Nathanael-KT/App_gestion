        ...
        <div class="flex flex-col lg:flex-row items-center justify-between">
          <div class="flex-1 mb-6 lg:mb-0">
            ...
            <p class="text-xl text-blue-100 mb-6 max-w-2xl">
              Gérez votre entreprise de carrelage avec efficacité. Suivez vos
              stocks, clients, commandes et finances depuis ce tableau de bord
              complet.
            </p>
          ...
          <!-- Quick Stats Widget -->
          <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-6 min-w-80">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        >
          ...
          <div class="flex items-center justify-between">
            ...
            <UButton variant="ghost" size="sm" to="/stock">Voir détail</UButton>
          </div>
        </div>
            ...
            <div>
              ...
              <div class="flex items-center mt-1">
                <UIcon
                  ...
                  class="w-4 h-4 text-green-500 mr-1"
                />
                <span class="text-sm text-green-600 font-medium">+12.8%</span>
              </div>
            </div>
        ...
        <div class="space-y-6">
          ...
          >
            <h2 class="text-xl font-bold text-gray-900 mb-6 flex items-center">
              <UIcon name="i-lucide-zap" class="w-6 h-6 mr-2 text-yellow-600" />
              Actions Rapides
            </h2>
            ...
            <div class="grid grid-cols-2 gap-3">
              ...
              >
                ...
                >
                  <UIcon name="i-lucide-plus" class="w-6 h-6 text-blue-600" />
                </div>
            ...
            <div class="space-y-4">
              <div class="flex items-center space-x-3">
                <div class="bg-indigo-100 p-2 rounded-lg">
                  <UIcon name="i-lucide-user" class="w-5 h-5 text-indigo-600" />
                </div>
                <div>
              ...
              <div class="flex items-center space-x-3">
                <div class="bg-indigo-100 p-2 rounded-lg">
                  <UIcon name="i-lucide-mail" class="w-5 h-5 text-indigo-600" />
                </div>
                <div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
          ...
          <div class="space-y-4">
            ...
            >
              <div class="flex items-center space-x-3">
                <div
                  :class="`p-1 rounded ${alert.bgColor.replace('50', '100')}`"
                >
                  <UIcon
                    :name="alert.icon"
