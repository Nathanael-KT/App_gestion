-- Squashed migration generated on 2026-03-25
-- Source: all previous migrations

-- Hard reset of public schema to guarantee a clean baseline.
DROP SCHEMA IF EXISTS public CASCADE;
CREATE SCHEMA public;
GRANT USAGE ON SCHEMA public TO anon, authenticated, service_role;
GRANT ALL ON SCHEMA public TO postgres, service_role;

-- BEGIN: 20250922071427_table.sql
...
-- BEGIN: 20250923000000_implement_multi_tenant_security.sql
...
-- BEGIN: 20250923114802_table1.sql
...
-- BEGIN: 20251013120100_add_status_to_company_subscription.sql
...
-- BEGIN: 20251013_add_blocked_to_company_settings.sql
-- Ajout du champ blocked à la table company_settings
ALTER TABLE public.company_settings
ADD COLUMN blocked boolean DEFAULT false;

-- BEGIN: 20260319122000_fix_clients_insert_rls.sql
...
-- BEGIN: 20260320000000_sync_auth_users_fix.sql
